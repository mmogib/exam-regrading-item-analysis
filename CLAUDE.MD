...
- **Implementation**:
  ...
  - UI: Accordion component in `components/uncoding.tsx` (orange-themed card)
...
- **Backward Compatible**: Works with old ItemAnalysis format (shows warning, skips distractor analysis)
